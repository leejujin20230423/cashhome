...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box }
        ...
        .nav { position: sticky; top: 0; z-index: 30; backdrop-filter: blur(12px); background: rgba(11, 18, 32, .55); border-bottom: 1px solid var(--line); }
        .navin { max-width: var(--max); margin: 0 auto; padding: 12px 18px; display: flex; align-items: center; justify-content: space-between; gap: 12px; }
        .brand { display: flex; align-items: center; gap: 12px; text-decoration: none }
        .logo { width: 40px; height: 40px; border-radius: 14px; background: linear-gradient(135deg, rgba(110, 231, 255, .9), rgba(167, 139, 250, .85)); box-shadow: var(--shadow); display: grid; place-items: center; font-weight: 800; color: #081022; letter-spacing: .5px; }
        ...
        .navlinks a { text-decoration: none; font-size: 13px; padding: 8px 10px; border-radius: 999px; border: 1px solid transparent; }
        .navlinks a:hover { color: var(--text); border-color: var(--line); background: rgba(255, 255, 255, .04); }
        .cta { text-decoration: none; padding: 10px 14px; border-radius: 999px; background: linear-gradient(135deg, rgba(110, 231, 255, .9), rgba(167, 139, 250, .9)); color: #061025; font-weight: 800; font-size: 13px; box-shadow: var(--shadow); border: 0; cursor: pointer; white-space: nowrap; }
        .hero { padding: 26px 0 10px; display: grid; gap: 16px; grid-template-columns: 1.2fr .8fr; align-items: stretch; }
        .card { background: rgba(16, 26, 51, .78); border: 1px solid var(--line); border-radius: var(--radius2); box-shadow: var(--shadow); }
        .heroL { padding: 26px 22px; }
        .kicker { display: inline-flex; gap: 8px; align-items: center; color: var(--muted); font-size: 12px; padding: 6px 10px; border: 1px solid var(--line); border-radius: 999px; background: rgba(255, 255, 255, .03); }
        ...
        .b { display: flex; gap: 10px; align-items: flex-start; padding: 10px 12px; border-radius: var(--radius); border: 1px solid var(--line); background: rgba(255, 255, 255, .03); }
        .b i { width: 22px; height: 22px; border-radius: 10px; background: rgba(110, 231, 255, .18); border: 1px solid rgba(110, 231, 255, .22); display: inline-block; margin-top: 1px; }
        ...
        .btnGhost { background: transparent; border: 1px solid var(--line); color: var(--text); padding: 10px 14px; border-radius: 999px; text-decoration: none; font-weight: 700; font-size: 13px; }
        .btnGhost:hover { background: rgba(255, 255, 255, .05); }
        .heroR { padding: 18px; display: grid; gap: 12px; }
        .mini { padding: 14px 14px; border-radius: var(--radius2); border: 1px solid var(--line); background: rgba(255, 255, 255, .03); }
        ...
        .consentIcon { width: 38px; height: 38px; border-radius: 14px; border: 1px solid rgba(234, 240, 255, .12); background: rgba(8, 12, 24, .55); display: grid; place-items: center; flex: 0 0 auto; margin-top: 2px; }
        .consentCheck { width: 22px; height: 22px; border-radius: 999px; border: 1px solid rgba(234, 240, 255, .22); background: rgba(8, 12, 24, .55); display: grid; place-items: center; flex: 0 0 auto; margin-top: 6px; }
        ...
        .chip { display: inline-flex; gap: 6px; align-items: center; padding: 4px 8px; border-radius: 999px; border: 1px solid rgba(234, 240, 255, .12); background: rgba(255, 255, 255, .03); color: var(--muted); font-size: 12px; }
        ...
        .consentCard:focus { outline: none; box-shadow: 0 0 0 3px rgba(110, 231, 255, .12); border-color: rgba(110, 231, 255, .35); }

        .alert { padding: 12px 14px; border-radius: 16px; border: 1px solid var(--line); background: rgba(255, 255, 255, .03); color: var(--text); font-size: 13px; }
        ...
        .topbtn { position: fixed; right: 16px; bottom: 16px; z-index: 50; padding: 10px 12px; border-radius: 999px; border: 1px solid var(--line); background: rgba(16, 26, 51, .8); color: var(--text); cursor: pointer; box-shadow: var(--shadow); display: none; }
        button[disabled] { opacity: .45; cursor: not-allowed; filter: grayscale(20%); }

        .kakao-btn {
            padding: 10px 14px; border-radius: 999px; font-weight: 800; font-size: 13px; text-decoration: none;
            display: inline-block; border: 0; cursor: pointer; transition: all .18s ease; white-space: nowrap;
            background: linear-gradient(135deg, #FEE500 0%, #F7D800 100%); color: #111;
            box-shadow: 0 8px 20px rgba(0, 0, 0, .25);
        }
        .kakao-btn:hover { transform: translateY(-2px); box-shadow: 0 12px 26px rgba(0, 0, 0, .35); background: linear-gradient(135deg, #FFE812 0%, #F5D000 100%); }
        .kakao-btn:active { transform: translateY(0px); box-shadow: 0 6px 16px rgba(0, 0, 0, .25); }
...
<main class="wrap" id="top">
    ...
    <section id="process">
        ...
        <div class="grid">
            <div class="card box col6"><h3>입력</h3><p>성함/연락처/희망금액/자금용도를 입력합니다. (요청사항은 선택)</p></div>
